...
public class SURFDetector1 {
    String result="";
    public  String main(String img1,String img2) {
        ...
        if (flag == 1) {
            ...
            if (os.toUpperCase().contains("WINDOWS")) {
                if (bitness.endsWith("64")) {
                  //  lib = new File("D:/opencv/build/java/java/x64/opencv_java2413.dll");
                    System.load("C:/opencv/build/java/x64/opencv_java2413.dll");
                } else {
                        System.load("C:/opencv/build/java/x86/opencv_java2413.dll");
                   // lib = new File("D:/opencv/build/java/java/x86/opencv_java2413.dll");
                }
            }
